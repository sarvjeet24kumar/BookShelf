...
class TestVerifyEmailView:
    ...
    def test_verify_email_success(
        self, mock_get_tenant, mock_find_user, mock_email_svc,
        verify_view, factory, mock_user, mock_tenant, fake_data
    ):
        ...
        request = factory.post("/api/v1/auth/verify-email/", {
    ...
    def test_verify_email_user_not_found(
        self, mock_get_tenant, mock_find_user, verify_view, factory, mock_tenant, fake_data
    ):
    ...
    def test_verify_email_already_verified(
        self, mock_get_tenant, mock_find_user, verify_view, factory, mock_user, mock_tenant, fake_data
    ):
...
class TestResendOTPView:
    ...
    def test_resend_otp_success(
        self, mock_get_tenant, mock_find_user, mock_email_svc,
        resend_view, factory, mock_user, mock_tenant
    ):
        ...
        request = factory.post("/api/v1/auth/resend-otp/", {
    ...
    def test_resend_otp_user_not_found_silent_response(
        self, mock_get_tenant, mock_find_user, resend_view, factory, mock_tenant, fake_data
    ):
    ...
    def test_resend_otp_already_verified(
        self, mock_get_tenant, mock_find_user, resend_view, factory, mock_user, mock_tenant
    ):
        """Already verified user should return 400."""
        mock_user.is_email_verified = True
        mock_get_tenant.return_value = mock_tenant
