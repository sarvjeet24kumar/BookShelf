...
class TestForgotPasswordView:
    ...
    def test_forgot_password_success(
        self, mock_get_tenant, mock_find_user, mock_reset_svc,
        forgot_view, factory, mock_user, mock_tenant, fake_data
    ):
        ...
        request = factory.post("/api/v1/auth/forgot-password/", {
    ...
    def test_forgot_password_user_not_found_silent_response(
        self, mock_get_tenant, mock_find_user, forgot_view, factory, mock_tenant, fake_data
    ):
...
class TestResetPasswordView:
    ...
    def test_reset_password_get_valid_token_renders_form(
        ...
        request = factory.get("/api/v1/auth/reset-password/", {"token": fake_data.sha256()})
